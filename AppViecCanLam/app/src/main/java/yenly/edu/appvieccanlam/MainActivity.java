package yenly.edu.appvieccanlam;
...
public class MainActivity extends AppCompatActivity {
 ...
 //               Log.w("VCL APP","Tên việc cần làm:"+ task.getName() );
        ...
        public void onCancelled(@NonNull DatabaseError error) {
            Toast.makeText(MainActivity.this, "Lỗi tải dữ liệu: " + error.getMessage(), Toast.LENGTH_LONG).show();
            Log.e("Firebase_Error", "Lỗi: " + error.getMessage());
